#SQL 50 - LeetCode
#Hi Everyone! SQL is my favorite coding language and I recently discovered SQL 50 which has all types of SQL questions that one can practice and I'd highly recommend to try it yourself!

#Solutions for SQL 50 on LeetCode below:
